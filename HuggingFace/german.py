...
HF_API_URL = "https://api-inference.huggingface.co/models/Helsinki-NLP/opus-mt-en-de"
# HF_API_KEY = "KEY"
OUTPUT_FILE = "HuggingFace/huggingface_translation_german.json"
...
def main():
    while True:
        ...
        german_translation, time_to_german = translate_with_huggingface_api(
            input_text, HF_API_URL, HF_API_KEY
        )
        ...
        reverse_url = "https://api-inference.huggingface.co/models/Helsinki-NLP/opus-mt-de-en"
        english_translation, time_to_english = translate_with_huggingface_api(
            german_translation, reverse_url, HF_API_KEY
        )
