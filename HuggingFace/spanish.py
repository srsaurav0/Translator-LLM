...
HF_API_URL_EN_ES = "https://api-inference.huggingface.co/models/Helsinki-NLP/opus-mt-en-es"
HF_API_URL_ES_EN = "https://api-inference.huggingface.co/models/Helsinki-NLP/opus-mt-es-en"
# HF_API_KEY = "KEY"
OUTPUT_FILE = "HuggingFace/huggingface_translation_spanish.json"
...
def main():
    while True:
        ...
        spanish_translation, time_to_spanish = translate_with_huggingface_api(
            input_text, HF_API_URL_EN_ES, HF_API_KEY
        )
        ...
        english_translation, time_to_english = translate_with_huggingface_api(
            spanish_translation, HF_API_URL_ES_EN, HF_API_KEY
        )
