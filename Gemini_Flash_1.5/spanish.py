...
OUTPUT_FILE = "gemini_flash_1.5_spanish.json"
...
def perform_pos_tagging(
    source_text, translated_text, source_lang="English", target_lang="Spanish"
):
    """
...
def main():
    while True:
        ...
        spanish_translation, time_to_spanish = translate_with_gemini(
        ...
        print(
            f"Translated to Spanish: {spanish_translation} (Time: {time_to_spanish:.2f} seconds)"
        )

        # Step 2: Spanish to English
