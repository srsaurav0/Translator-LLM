...
OUTPUT_FILE = "gemini_flash_1.5_german.json"
...
def perform_pos_tagging(
    source_text, translated_text, source_lang="English", target_lang="German"
):
    """
    ...
    try:
        ...
        target_nlp = nlp_es if target_lang == "German" else nlp_en
...
def main():
    while True:
        ...
        german_translation, time_to_german = translate_with_gemini(
        ...
        print(
            f"Translated to German: {german_translation} (Time: {time_to_german:.2f} seconds)"
        )

        # Step 2: German to English
