...
OUTPUT_FILE = "MistralAI/mistral_translation_french.json"
...
def translate_with_codestral(input_text, source_lang="English", target_lang="French"):
    """
    ...
    :param target_lang: The target language (e.g., "French").
